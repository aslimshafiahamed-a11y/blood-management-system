      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden z-10">
        ...
        <div className="p-6 sm:p-8 md:p-10 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-1 mb-6">
              ...
              <p className="font-small text-slate-500">Authenticate to access your role-based blood management workspace.</p>
            </div>
              ...
              <div className="space-y-1.5">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3.5 top-8 text-slate-400 hover:text-slate-700 font-caption"
                  >
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 space-y-3">
              <div className="flex items-center gap-1.5 font-caption text-slate-500 font-bold">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="px-2.5 py-2 rounded-xl bg-slate-50 border border-slate-200 hover:border-red-500 text-left font-caption transition-colors"
                >
                  <span className="font-bold text-red-600 block">System Admin</span>
                  <span className="text-slate-500 font-normal">admin@bloodline.org</span>
                </button>
                <button
                  type="button"
                  onClick={() => handleDemoSelect('BLOOD_BANK_STAFF')}
                  className="px-2.5 py-2 rounded-xl bg-slate-50 border border-slate-200 hover:border-blood-500 text-left font-caption transition-colors"
                >
                  <span className="font-bold text-blood-600 block">Blood Bank Staff</span>
                  <span className="text-slate-500 font-normal">bank@bloodline.org</span>
                </button>
                <button
                  type="button"
                  onClick={() => handleDemoSelect('HOSPITAL_STAFF')}
                  className="px-2.5 py-2 rounded-xl bg-slate-50 border border-slate-200 hover:border-secondary-500 text-left font-caption transition-colors"
                >
                  <span className="font-bold text-secondary-600 block">Hospital Staff</span>
                  <span className="text-slate-500 font-normal">hospital@bloodline.org</span>
                </button>
                <button
                  type="button"
                  onClick={() => handleDemoSelect('DONOR')}
                  className="px-2.5 py-2 rounded-xl bg-slate-50 border border-slate-200 hover:border-primary-500 text-left font-caption transition-colors"
                >
                  <span className="font-bold text-primary-600 block">Donor Account</span>
                  <span className="text-slate-500 font-normal">donor@bloodline.org</span>
                </button>
              </div>
            </div>
          </div>

          <p className="mt-8 text-center font-caption text-slate-500">
        ...
        <div className="hidden lg:flex flex-col justify-between p-10 bg-slate-50 border-l border-slate-200 relative">
          <div className="space-y-4 z-10">
            ...
            <p className="font-small text-slate-600 leading-relaxed">
          ...
          <div className="flex items-center gap-2 font-caption text-slate-500 font-medium z-10">
