    ...
    extend: {
      colors: {
        primary: {
          ...
          300: '#5eead4',
          400: '#2dd4bf',
          500: '#0ea5a4', // Healthcare Teal Primary
          600: '#0d9488',
          700: '#0f766e',
          800: '#115e59',
          900: '#134e4a',
        ...
        secondary: {
          ...
          200: '#bfdbfe',
          500: '#3b82f6',
          600: '#2563eb', // Medical Blue Secondary
          700: '#1d4ed8',
          800: '#1e40af',
        },
        blood: {
          ...
          200: '#ffc8c8',
          500: '#ef4444',
          600: '#dc2626', // Crimson Blood Accent
          700: '#b91c1c',
          800: '#991b1b',
        },
        slate: {
      ...
      fontSize: {
        ...
        'h2': ['30px', { lineHeight: '38px', letterSpacing: '-0.01em' }],
      ...
      boxShadow: {
        ...
        'glow-teal': '0 0 20px -5px rgba(14, 165, 164, 0.3)',
        'glow-blue': '0 0 20px -5px rgba(37, 99, 235, 0.3)',
        'glow-red': '0 0 20px -5px rgba(220, 38, 38, 0.3)',
      }
    },
  },
  plugins: [],
